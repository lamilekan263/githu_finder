        ...
        return (
            <Fragment>
              ...
              <div className="max-w-lg w-full lg:max-w-full mt-8 lg:flex shadow-lg">
                    <img className="h-48 lg:h-auto lg:w-48 flex-auto bg-cover rounded-t lg:rounded-t-none lg:rounded-l  text-center overflow-hidden" src={avatar_url} alt="pic of the user"/>
